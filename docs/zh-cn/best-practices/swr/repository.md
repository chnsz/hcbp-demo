...
> 注意：镜像仓库必须属于某个组织，因此需要先创建组织。镜像仓库通过引用组织名称来关联到对应的组织。
...
> 注意：镜像仓库名称在组织内必须唯一。仓库分类用于标识镜像的类型，支持 `linux`、`windows` 等类型。创建镜像仓库后，可以通过推送镜像到该仓库来存储容器镜像。
...
3. 确认资源计划无误后，运行 `terraform apply` 开始创建组织和镜像仓库
4. 运行 `terraform show` 查看已创建的镜像仓库

## 参考信息

- [华为云SWR产品文档](https://support.huaweicloud.com/swr/index.html)
- [华为云Provider文档](https://registry.terraform.io/providers/huaweicloud/huaweicloud/latest/docs)
- [SWR镜像仓库最佳实践源码参考](https://github.com/huaweicloud/terraform-provider-huaweicloud/tree/master/examples/swr/repository)
