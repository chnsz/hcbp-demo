...
* [部署DataArts Security数据识别规则组](security_data_recognition_rule_group.md) - 介绍如何使用Terraform自动化部署DataArts Security数据识别规则组，包括工作空间查询、数据分类查询、数据密级、数据识别规则及规则组的创建与验证。
* [部署DataArts Studio工作空间用户](studio_workspace_user.md) - 介绍如何使用Terraform自动化部署DataArts Studio工作空间用户，包括工作空间查询、用户角色查询、IAM用户查询及工作空间用户创建与角色分配。
