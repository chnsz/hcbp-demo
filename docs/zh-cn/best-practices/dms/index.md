...
* [部署实例数据复制](kafka/replicate_instance_data.md) - 介绍如何使用Terraform自动化部署Kafka实例数据复制，包括创建多个Kafka实例、Smart Connect和Smart Connect任务。
* [部署主题消息生产](kafka/topic_message_produce.md) - 介绍如何使用Terraform自动化部署Kafka主题消息生产，包括创建Kafka实例、主题和消息生产。
