...
本最佳实践将介绍如何使用Terraform自动化部署一个关联单集群的基础ASM网格，包括指定网格名称、类型、版本，以及将网格组件安装到指定CCE集群节点。
...
> 注意：创建基础ASM网格前，请确保目标CCE集群及节点已就绪，并将`cluster_id`、`node_id`替换为实际可用的资源ID。
...
1. 命令行参数：`terraform apply -var="mesh_name=basic-mesh" -var="mesh_version=1.18.7-r7"`
2. 环境变量：`export TF_VAR_mesh_name=basic-mesh`
...
3. 确认资源计划无误后，运行 `terraform apply` 开始创建ASM网格
4. 运行 `terraform show` 查看已创建的ASM网格

## 参考信息

- [华为云ASM产品文档](https://support.huaweicloud.com/asm/index.html)
- [华为云Provider文档](https://registry.terraform.io/providers/huaweicloud/huaweicloud/latest/docs)
- [ASM基础网格最佳实践源码参考](https://github.com/huaweicloud/terraform-provider-huaweicloud/tree/master/examples/asm/basic)
