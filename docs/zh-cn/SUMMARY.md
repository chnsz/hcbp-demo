...
* [最佳实践](best-practices/)
  ...
  * [CPTS](best-practices/cpts/)
    ...
    * [部署CPTS项目与测试任务](best-practices/cpts/project_with_task.md)
  ...
  * [DDM](best-practices/ddm/)
    * [部署DDM账号](best-practices/ddm/ddm_account.md)
  ...
  * [DDS](best-practices/dds/)
    ...
    * [部署集群实例](best-practices/dds/cluster_instance.md)
    ...
    * [部署只读节点](best-practices/dds/readonly_node.md)
  ...
  * [DIS](best-practices/dis/)
    * [简介](best-practices/dis/index.md)
    * [部署DIS通道](best-practices/dis/stream.md)
  * [DLI](best-practices/dli/)
    ...
    * [部署队列公网连通](best-practices/dli/queue_public_network_connectivity.md)
  * [DMS](best-practices/dms/)
    ...
    * [部署RabbitMQ监控与CES告警通知](best-practices/dms/rabbitmq/monitoring_with_ces_smn_alarm.md)
  ...
  * [DRS](best-practices/drs/)
    ...
    * [部署LTS配置](best-practices/drs/lts_config.md)
  ...
  * [GEMINIDB](best-practices/geminidb/)
    * [简介](best-practices/geminidb/index.md)
    * [部署GeminiDB Cassandra实例](best-practices/geminidb/geminidb_cassandra_instance.md)
