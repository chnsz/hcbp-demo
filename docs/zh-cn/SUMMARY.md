...
* [最佳实践](best-practices/)
  ...
  * [CTS](best-practices/cts/)
    ...
    * [使用Terraform创建CTS数据跟踪器](best-practices/cts/data_tracker.md)
    * [使用Terraform创建CTS通知](best-practices/cts/notification.md)
    * [使用Terraform创建CTS系统追踪器](best-practices/cts/system_tracker.md)
  ...
  * [FunctionGraph](best-practices/fgs/)
    ...
    * [使用FunctionGraph创建CTS触发器](best-practices/fgs/cts_trigger.md)
    * [使用FunctionGraph创建EG触发器](best-practices/fgs/eg_trigger.md)
    * [使用FunctionGraph创建定时触发器](best-practices/fgs/timer_trigger.md)
