...
* [Deploy Custom Event Subscription](custom.md) - Introduces how to use Terraform to automatically deploy custom event subscriptions, including custom event channel creation, custom event source configuration, EG connection query, and event subscription management.
...
* [Deploy Event Subscription (OBS Event Source, Kafka Event Target)](obs_to_kafka.md) - Introduces how to use Terraform to automatically deploy Event Subscription (OBS Event Source, Kafka Event Target), including Availability Zones (data.), Kafka Flavors (data.), Event Channels (data.), VPC creation, and subnet configuration.
