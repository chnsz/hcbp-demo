...
- [Kubernetes Namespace Resource (kubernetes_namespace)](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/namespace)
...
- **depends_on**: Explicit dependency relationship, ensuring the CCE node resource is created before the namespace
