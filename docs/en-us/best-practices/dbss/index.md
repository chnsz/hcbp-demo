...
Through the best practices in this section, you can learn the main deployment processes for DBSS resources. These best practices will help you quickly get started with automated DBSS deployment and lay a solid foundation for subsequent management and operations of database security audit instances and ECS self-built database auditing.
