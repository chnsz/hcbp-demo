...
* [Best Practices](best-practices/)
  ...
  * [AAD](best-practices/aad/)
    ...
    * [Deploy Black/White Lists](best-practices/aad/black_white_lists.md)
  ...
  * [CPTS](best-practices/cpts/)
    * [Introduction](best-practices/cpts/index.md)
    * [Deploy CPTS Project and Test Task](best-practices/cpts/project_with_task.md)
  ...
  * [DDS](best-practices/dds/)
    ...
    * [Deploy Cluster Instance](best-practices/dds/cluster_instance.md)
    ...
    * [Deploy Readonly Node](best-practices/dds/readonly_node.md)
  ...
  * [DIS](best-practices/dis/)
    * [Introduction](best-practices/dis/index.md)
    * [Deploy DIS Stream](best-practices/dis/stream.md)
  ...
  * [DMS](best-practices/dms/)
    ...
    * [Deploy RabbitMQ Message Producer and Consumer](best-practices/dms/message_producer_and_consumer.md)
    * [Deploy RabbitMQ Monitoring with CES Alarm Notifications](best-practices/dms/rabbitmq/monitoring_with_ces_smn_alarm.md)
  ...
  * [DSC](best-practices/dsc/)
    ...
    * [Deploy Custom Scan Rule with Template](best-practices/dsc/scan_rule_with_custom_template.md)
  ...
  * [GEMINIDB](best-practices/geminidb/)
    * [Introduction](best-practices/geminidb/index.md)
    * [Deploy GeminiDB Cassandra Instance](best-practices/geminidb/geminidb_cassandra_instance.md)
