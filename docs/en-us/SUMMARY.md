...
* [Best Practices](best-practices/)
  ...
  * [DCS](best-practices/dcs/)
    ...
    * [Deploy Single Redis Instance](best-practices/dcs/redis_single_instance.md)
    * [Deploy HA Redis Instance](best-practices/dcs/redis_ha_instance.md)
  ...
  * [ECS](best-practices/ecs/)
    ...
    * [Deploy Basic Elastic Cloud Server](best-practices/ecs/simple_instance.md)
  ...
  * [EVS](best-practices/evs/)
    ...
    * [Deploy Volume](best-practices/evs/volume.md)
    * [Deploy Snapshot](best-practices/evs/snapshot.md)
    * [Deploy Snapshot Group](best-practices/evs/snapshot_group.md)
  ...
  * [ER](best-practices/er/)
    ...
    * [Deploy VPC Attachment](best-practices/er/vpc_attachment.md)
    * [Deploy Share Instance](best-practices/er/share_instance.md)
  ...
  * [OBS](best-practices/obs/)
    ...
    * [Deploy Bucket Static Website Hosting](best-practices/obs/static_website_hosting.md)
    * [Deploy Object Upload with Content](best-practices/obs/object_upload_with_content.md)
    * [Deploy Object Upload with Encryption](best-practices/obs/object_upload_with_encryption.md)
    * [Deploy Object Upload with Source](best-practices/obs/object_upload_with_source.md)
  * [OMS](best-practices/oms/)
    * [Introduction](best-practices/oms/index.md)
    * [Deploy Group Migration](best-practices/oms/group_migration.md)
    * [Deploy Task Migration](best-practices/oms/task_migration.md)
  ...
  * [SFS Turbo](best-practices/sfs-turbo/)
    ...
    * [Deploy File System](best-practices/sfs-turbo/file_system.md)
  ...
  * [VPC](best-practices/vpc/)
    ...
    * [Deploy Basic VPC Network](best-practices/vpc/basic.md)
  ...
  * [WAF](best-practices/waf/)
    ...
    * [Deploy Dedicated Domain](best-practices/waf/dedicated_domain.md)
    * [Deploy Dedicated Instance](best-practices/waf/dedicated_instance.md)
